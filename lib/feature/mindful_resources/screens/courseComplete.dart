              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    ...
                    color: Color(0xff4F3422), // Change text color to black for better visibility
                    shadows: [
                      Shadow(
                        color: Colors.white,
                        blurRadius: 2,
                ...
                Text(
                  ...
                  style: TextStyle(
                    ...
                    color: Color(0xff726d69), // Change text color to black for better visibility
                    shadows: [
                      Shadow(
                        color: Colors.white,
                        blurRadius: 2,
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    padding: EdgeInsets.symmetric(vertical: 16.0, horizontal: 70.0), backgroundColor: Color(0xff4F3422),
