...
class _AudioPlayerWidgetState extends State<AudioPlayerWidget> {
  ...
  void complete() {
    ...
    Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) =>
                CourseComplete())); // Navigate back to the previous page
  }
            ...
            body: Column(
              ...
              children: [
                ...
                Slider(
                  ...
                  activeColor:
                      Colors.white, // Customize the active color of the slider
                  inactiveColor:
                      Colors.grey, // Customize the inactive color of the slider
                ),
                SizedBox(
                  height: 20.0,
                ),
